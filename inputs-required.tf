variable "peerings" {
  ...
  validation {
    condition = alltrue([
      ...
      (var.peerings["source"].vnet_name != null && var.peerings["source"].resource_group != null) || var.peerings["source"].vnet_id != null,
      (var.peerings["target"].vnet_name != null && var.peerings["target"].resource_group != null) || var.peerings["target"].vnet_id != null,
    ])
